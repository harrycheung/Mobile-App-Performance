...
- (void)setLapTimeWithStartTime:(double)startTime
  ...
  _lapTime = _timestamp - startTime;
  _splitTime = _timestamp - splitStartTime;
}

- (double)latitudeDegrees {
  return [HCMPoint roundValue:[HCMPoint toDegrees:_latitude]];
}

- (double)longitudeDegrees {
  return [HCMPoint roundValue:[HCMPoint toDegrees:_longitude]];
}

- (HCMPoint*)subtractWithPoint:(HCMPoint*)point {
  return [[[HCMPoint alloc] initWithLatitude:_latitude - point.latitude
                                   longitude:_longitude - point.longitude
...
- (double)bearingToPoint:(HCMPoint*)point inRadians:(BOOL)inRadians {
  ...
  double Δλ = point.longitude - _longitude;
