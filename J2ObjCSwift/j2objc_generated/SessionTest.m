...
- (void)singleLapSession {
  JavaIoFileReader *fileReader = [[[JavaIoFileReader alloc] initWithNSString:@"./Assets/single_lap_session.csv"] autorelease];
...
- (void)multiLapSession {
  JavaIoFileReader *fileReader = [[[JavaIoFileReader alloc] initWithNSString:@"./Assets/multi_lap_session.csv"] autorelease];
  JavaIoBufferedReader *bufferedReader = [[[JavaIoBufferedReader alloc] initWithJavaIoReader:fileReader] autorelease];
  NSString *line;
  [((HCMSessionManager *) nil_chk(HCMSessionManager_getInstance())) startSessionWithHCMTrack:track_];
  jdouble startTime = JavaLangSystem_currentTimeMillis() / 1000;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "track_", NULL, 0x2, "Lharrycheung.map.Track;", NULL,  },
  };
  static const J2ObjcClassInfo _HCMSessionTest = { 1, "SessionTest", "harrycheung.map", NULL, 0x11, 5, methods, 1, fields, 0, NULL};
