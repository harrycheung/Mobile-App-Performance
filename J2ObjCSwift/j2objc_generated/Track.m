...
- (instancetype)initWithOrgJsonJSONObject:(OrgJsonJSONObject *)json {
  if (self = [super init]) {
    ...
    NSAssert((id__ != 0), @"harrycheung/map/Track.java:42 condition failed: assert(id != 0);");
    NSAssert((name_ != nil), @"harrycheung/map/Track.java:43 condition failed: assert(name != null);");
    NSAssert((start_ != nil), @"harrycheung/map/Track.java:44 condition failed: assert(start != null);");
  }
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "load__WithNSString:", "load", "[Lharrycheung.map.Track;", 0x9, NULL },
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "gates_", NULL, 0x4, "[Lharrycheung.map.Gate;", NULL,  },
    { "id__", "id", 0x4, "I", NULL,  },
    { "start_", NULL, 0x4, "Lharrycheung.map.Gate;", NULL,  },
  };
  static const J2ObjcClassInfo _HCMTrack = { 1, "Track", "harrycheung.map", NULL, 0x11, 4, methods, 4, fields, 0, NULL};
  return &_HCMTrack;
}
