...
exports.Point = function (latitude, longitude, inRadians,
  speed, bearing, horizontalAccuracy, verticalAccuracy, timestamp) {
  
  var inRadians = typeof inRadians !== 'undefined' ? inRadians : false;
  if (inRadians) {
...
MAP.Point.intersectSimple = function (p, p2, q, q2) {
